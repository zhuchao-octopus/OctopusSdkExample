...
import com.octopus.example.databinding.ActivityFullscreenBinding;
    ...
    private final Runnable mHidePart2Runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                mContentView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_IMMERSIVE | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);
